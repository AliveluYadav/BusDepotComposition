...
-(void)detailsOfDeluxeBus
{
    
    Seat *seat=[[Seat alloc]initWithNumberOfSeats:30 footRest:@" Not Available" handRest:@" Available" seatAdjustmentFacility:@"not Available"];
    [seat seatDetails];
