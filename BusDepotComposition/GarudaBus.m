...
-(void)detailsOfGarudaBus
{
    
    Seat *seat=[[Seat alloc]initWithNumberOfSeats:40 footRest:@"  Available" handRest:@" Available" seatAdjustmentFacility:@" Available"];
    [seat seatDetails];
